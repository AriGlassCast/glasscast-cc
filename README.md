...
- **News crawl** → DOOH/OOH headlines from the daily PrimeSight Morning Brief email, refreshed ~6am ET (the `refresh-news-crawl` task writes news-data.json); dashboard fetches news-data.json every 15 min
